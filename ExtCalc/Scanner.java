	...
	Token NextToken() {
		...
		loop: for (;;) {
			switch (state) {
				...
				case 1:
					if (ch == 'a') {AddCh(); state = 2; break;}
					else {state = 0; break;}
				case 2:
					if (ch == 'i') {AddCh(); state = 3; break;}
					else {state = 0; break;}
				case 3:
				...
				case 4:
					{t.kind = 1; break loop;}
				case 5:
					if (ch == 'z') {AddCh(); state = 6; break;}
					else {state = 0; break;}
				case 6:
					if (ch == 'e') {AddCh(); state = 7; break;}
					else {state = 0; break;}
				case 7:
				...
				case 9:
					{t.kind = 3; break loop;}
				case 10:
					if (ch == 'e') {AddCh(); state = 11; break;}
					else {state = 0; break;}
				case 11:
					if (ch == 'r') {AddCh(); state = 12; break;}
					else {state = 0; break;}
				case 12:
					if (ch == 'o') {AddCh(); state = 13; break;}
					else {state = 0; break;}
				case 13:
					{t.kind = 4; break loop;}
				case 14:
					if (ch == 'm') {AddCh(); state = 15; break;}
					else {state = 0; break;}
				case 15:
					{t.kind = 5; break loop;}
				case 16:
				...
				case 18:
					{t.kind = 6; break loop;}
				case 19:
					if (ch == 's') {AddCh(); state = 20; break;}
					else {state = 0; break;}
				case 20:
					{t.kind = 7; break loop;}
				case 21:
					if (ch == 'r') {AddCh(); state = 22; break;}
					else {state = 0; break;}
				case 22:
					if (ch == 'o') {AddCh(); state = 23; break;}
					else {state = 0; break;}
				case 23:
					{t.kind = 8; break loop;}
				case 24:
					if (ch == 'o') {AddCh(); state = 25; break;}
					else {state = 0; break;}
				case 25:
					{t.kind = 9; break loop;}
				case 26:
					if (ch == 's') {AddCh(); state = 27; break;}
					else {state = 0; break;}
				case 27:
				...
				case 50:
					if (ch == 's') {AddCh(); state = 51; break;}
					else {state = 0; break;}
				case 51:
					if (ch == 'e') {AddCh(); state = 52; break;}
					else {state = 0; break;}
				case 52:
				...
				case 54:
					if (ch == 'a') {AddCh(); state = 55; break;}
					else {state = 0; break;}
				case 55:
					{t.kind = 19; break loop;}
				case 56:
					if (ch == 't') {AddCh(); state = 57; break;}
					else {state = 0; break;}
				case 57:
					if (ch == 'a') {AddCh(); state = 58; break;}
					else {state = 0; break;}
				case 58:
					{t.kind = 20; break loop;}
				case 59:
					if (ch == 'n') {AddCh(); state = 60; break;}
					else {state = 0; break;}
				case 60:
					if (ch == 't') {AddCh(); state = 61; break;}
					else {state = 0; break;}
				case 61:
					if (ch == 'a') {AddCh(); state = 62; break;}
					else {state = 0; break;}
				case 62:
				...
				case 64:
					if (ch == 'a') {AddCh(); state = 65; break;}
					else {state = 0; break;}
				case 65:
					{t.kind = 22; break loop;}
				case 66:
					if (ch == 'e') {AddCh(); state = 5; break;}
					else if (ch == 'i') {AddCh(); state = 31; break;}
					else {state = 0; break;}
				case 67:
					if (ch == 'o') {AddCh(); state = 16; break;}
					else if (ch == 'e') {AddCh(); state = 29; break;}
					else {state = 0; break;}
				case 68:
					if (ch == 'r') {AddCh(); state = 74; break;}
					else {state = 0; break;}
				case 69:
					if (ch == 'u') {AddCh(); state = 75; break;}
					else {state = 0; break;}
				case 70:
					if (ch == 'i') {AddCh(); state = 76; break;}
					else {state = 0; break;}
				case 71:
					if (ch == 'e') {AddCh(); state = 77; break;}
					else {state = 0; break;}
				case 72:
					if (ch == 'i') {AddCh(); state = 78; break;}
					else {state = 0; break;}
				case 73:
					if (ch == 'o') {AddCh(); state = 79; break;}
					else {state = 0; break;}
				case 74:
					if (ch == 'e') {AddCh(); state = 19; break;}
					else if (ch == 'i') {AddCh(); state = 35; break;}
					else {state = 0; break;}
				case 75:
					if (ch == 'a') {AddCh(); state = 80; break;}
					else {state = 0; break;}
				case 76:
					if (ch == 'n') {AddCh(); state = 81; break;}
					else {state = 0; break;}
				case 77:
					if (ch == 'i') {AddCh(); state = 26; break;}
					else if (ch == 't') {AddCh(); state = 82; break;}
					else if (ch == 's') {AddCh(); state = 50; break;}
					else {state = 0; break;}
				case 78:
					if (ch == 't') {AddCh(); state = 83; break;}
					else {state = 0; break;}
				case 79:
					if (ch == 'v') {AddCh(); state = 84; break;}
					else {state = 0; break;}
				case 80:
					if (ch == 't') {AddCh(); state = 21; break;}
					else if (ch == 'r') {AddCh(); state = 39; break;}
					else {state = 0; break;}
				case 81:
					if (ch == 'c') {AddCh(); state = 24; break;}
					else if (ch == 'q') {AddCh(); state = 44; break;}
					else {state = 0; break;}
				case 82:
				...
				case 83:
					...
					else if (ch == 'e') {AddCh(); state = 59; break;}
					else {state = 0; break;}
				case 84:
				...
				case 85:
					...
					if (ch == 'n') {AddCh(); state = 56; break;}
					else {t.kind = 11; break loop;}
				case 86:
					recEnd = pos; recKind = 13;
					if (ch == 'n') {AddCh(); state = 63; break;}
